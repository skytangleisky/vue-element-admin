<template>
  <el-container direction="horizontal" style="height:100%">
    <div ref="editor" contenteditable="true" style="font-family:Menlo,Consolas,Monaco;font-size:8px;position:relative;box-sizing: border-box;height:100%;width:100%;outline:none;" />
