    ...
    <div style="display:flex;flex-direction:row;flex-wrap:wrap">
      ...
      <div v-for="(o, index) in list2" :key="index" style="padding:5px;">
        <div class="card" style="position:relative;border-radius:8px;border:0px solid #00000044;box-shadow: 0px 0px 10px #909090;overflow:hidden;">
          <a target="_blank" :href="baseURL+'/'+o.product_root+o.product_url"><img :src="baseURL+'/'+o.product_root+o.product_image" :style="'user-drag:none;display:block;'+(o.width>0?('width:'+o.width+'px;'):'')+(o.height>0?('height:'+o.height+'px;'):'')"></a>
