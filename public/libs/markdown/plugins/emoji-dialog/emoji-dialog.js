	...
	var factory = function (exports) {
		...
		exports.fn.emojiDialog = function() {
                        ...
                        for (var x = 0; x < rowNumber; x++)
                        {
                            ...
                            if (typeof emoji !== "undefined" && emoji !== "")
                            {
                                ...
                                if (type === "github-emoji")
                                {
                                    ...
                                    var src     = exports.emoji.path + emoji + exports.emoji.ext;
                                    
                                    
                                    
                                    
                                    // if(!src.match(/(http|https):\/\/([\w.]+\/?)\S*/)){
                                    ...
                                    //     return url;
                                    // }
                                    // $.ajax({url:'http://127.0.0.1/tinyfilemanager-master/common/downloadFile.php',data:{'name':emoji,'url':src},success:function (e) {
                                    //         console.log(e);
                                    //     },error:function (e) {
                                    //         console.error(e);
                                    //     },type:'post'});
			...
			{            
				...
				//tanglei  emoji.json不能使用cdn加速，否则会因为跨域而不能使用
                //$.getJSON(path + "emoji.json?temp=" + Math.random(), function(json) {
				$.getJSON("/libs/markdown/plugins/emoji-dialog/emoji.json.php?temp=" + Math.random(), function(json) {
					if (typeof dialog.loading === "function") {
