var apiContent = {
	...
	_init: function() {
      ...
      {id:210, pId:20, t:"xhrFields", name:"xhrFields : {},", iconSkin:"core", showAPI:true},
		...
		apiContent.zTree_Setting = $.fn.zTree.init($("#settingTree"), setting_nodes);
		apiContent.zTree_Node = $.fn.zTree.init($("#treenodeTree"), treenode_nodes);
		apiContent.zTree_Function = $.fn.zTree.init($("#functionTree"), function_nodes);
		this.bindEvent();
