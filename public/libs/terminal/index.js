!function(e) {
  ...
  window,
    e.exports = function(e) {
        ...
        var o = r(36)
          ...
          return n(t, e),
            ...
            t.prototype.open = function(e) {
              ...
              D.body.contains(e) || this._logService.debug("Terminal.open was called on an element that was not attached to the DOM"),
            ...
            e.prototype._finalizeComposition = function(e) {
              ...
              if (this._compositionView.classList.remove("active"),
                ...
                this._isSendingComposition = !0,
                  setTimeout((function() {
                      var e;
                      t._isSendingComposition && (t._isSendingComposition = !1,
        ...
        var a = r(1)
          ...
          return n(t, e),
            ...
            t.prototype._askForLink = function(e, t) {
              var r = this;
              this._activeProviderReplies && t || (this._activeProviderReplies = new Map,
              ...
              this._linkProviders.forEach((function(n, o) {
                  ...
                  t ? (null === (s = r._activeProviderReplies) || void 0 === s ? void 0 : s.get(o)) && (i = r._checkLinkProviderResult(o, e, i)) : n.provideLinks(e.y, (function(t) {
                      ...
                      if (!r._isMouseOut) {
                        ...
                        null === (n = r._activeProviderReplies) || void 0 === n || n.set(o, a),
                          i = r._checkLinkProviderResult(o, e, i),
                        (null === (s = r._activeProviderReplies) || void 0 === s ? void 0 : s.size) === r._linkProviders.length && r._removeIntersectingLinks(e.y, r._activeProviderReplies)
                      }
                    }
                  ))
                }
            ...
            e.prototype._reflowSmaller = function(e, t) {
              ...
              if (i.length > 0) {
                ...
                for (v = Math.min(this.lines.maxLength - 1, R + o - 1); v >= 0; v--)
                  if (T && T.start > k + D) {
                    for (var O = T.newLines.length - 1; O >= 0; O--)
                      this.lines.set(v--, T.newLines[O]);
                    v++,
                      L.push({
                        index: k + 1,
      ...
      , function(e, t, r) {
        "use strict";
        var s = document.getElementById("terminal");
        let cols = Number(s.getAttribute("cols"));
        let rows = Number(s.getAttribute("rows"));
        Object.defineProperty(t, "__esModule", {
          value: !0
        }),
      ...
      e.exports = function(e) {
        ...
        var i = function() {
          ...
          return e.prototype.activate = function(e) {
            var t = this;
            this._disposables.push(n(this._socket, "message", (function(t) {
                var r = t.data;
                e.write("string" == typeof r ? r : new Uint8Array(r))
              }
            ))),
            this._bidirectional && (this._disposables.push(e.onData((function(e) {
                return t._sendData(e)
              }
            ))),
              this._disposables.push(e.onBinary((function(e) {
                  return t._sendBinary(e)
                }
              )))),
              this._disposables.push(n(this._socket, "close", (function() {
                  return t.dispose()
                }
              ))),
              this._disposables.push(n(this._socket, "error", (function() {
                  return t.dispose()
                }
              )))
          }
            ...
            ,
            e.prototype._sendData = function(e) {
              1 === this._socket.readyState && this._socket.send(e)
            }
            ,
            e.prototype._sendBinary = function(e) {
  ...
  , function(e, t, r) {
    ...
    var i = r(0)
      , n = r(1);
    const o = new i.Terminal
      , s = document.getElementById("terminal");
    // let host = '192.168.0.201:4000';
    let host = 'localhost:4000';
    let a, c, l;
    for (; s.children.length; )
      s.removeChild(s.children[0]);
    o.open(s),
      //o.write("Hello from [1;3;31mxterm.js[0m $ "),
      c = "ws://"+host+"/terminals/",
      fetch("http://"+host+"/terminals?cols=" + o.cols + "&rows=" + o.rows, {
        method: "POST"
      }).then(e=>{
          e.text().then(e=>{
              console.log("get processId:", e),
                a = e,
                c += e,
                console.log("open webSocket URL:", c),
                l = new WebSocket(c);
              const t = new n.AttachAddon(l);
              o.loadAddon(t);
              var fitAddon = new n.FitAddon();
              o.loadAddon(fitAddon);
      ...
      o.onResize(e=>{
          if (console.log("==hugo Terminal onResize", e),
          !a || e.rows < 3)
            return;
          const t = e.cols
            , r = e.rows;
          fetch("http://"+host+"/terminals/" + a + "/size?cols=" + t + "&rows=" + r, {
            method: "POST"
          })
        }
      )
