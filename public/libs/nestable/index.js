  ...
  Plugin.prototype = {
    ...
    asNestedSet: function () {
      ...
      function traverse(item, depth, lft) {
        ...
        if (
          $(item).children(o.listNodeName).children(o.itemNodeName).length > 0
        ) {
          depth++;
          $(item)
    ...
    toArray: function () {
      ...
      function _recursiveArray(item, depth, left) {
        ...
        if (
          item.children(o.options.listNodeName).children(o.options.itemNodeName)
            .length > 0
        ) {
          depth++;
          item
      ...
      if (opt.scroll) {
        if (typeof window.jQuery.fn.scrollParent !== "undefined") {
          ...
          if (scrollParent !== document && scrollParent.tagName !== "HTML") {
            if (
              opt.scrollTriggers.bottom + scrollParent.offsetHeight - e.pageY <
            ...
            if (
              opt.scrollTriggers.right + scrollParent.offsetWidth - e.pageX <
              opt.scrollSensitivity
            )
